...
vcd file -direction somador_completo_case.msim.vcd
vcd add -internal somador_completo_case_vlg_vec_tst/*
vcd add -internal somador_completo_case_vlg_vec_tst/i1/*
proc simTimestamp {} {
